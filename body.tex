...
\section{Education}
\cventry{2011--2015}{PhD. High Energy Physics}{Imperial College London \& CERN}{}{}
{
  \begin{itemize}
    \item Thesis title:
...
\cvline{Languages}{Python, \cpp, Bash, MatLab, SQL}
\cvline{Python packages}{pandas, numpy, matplotlib, scipy, sklearn}
\cvline{Tools}{Git, SVN, \LaTeX, MS Office}
\cvline{OS}{OSX, Linux, Windows}
