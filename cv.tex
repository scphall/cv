...
\cventry{}{Enjoy many sports, main interests are:}{Sports}{}{}{
  \begin{itemize}
    \item Squash.
      Captained my college team at University, England Squash Level 1 registered coach
    \item Cycling.
      Enthusiatic cyclist, Cycled from Geneva to London last summer
    \item Also a keen skier
  \end{itemize}
}
...
\cventry{}{Other hobbies include:}{Other activities}{}{}{
  \begin{itemize}
    \item Travel.
      Excited by exploring new places
    \item Hiking.
    \item Photography.
  \end{itemize}
}
